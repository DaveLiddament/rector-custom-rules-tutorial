...
Rector rule has 3 methods to populate.
...
3. Fill in the example code for `getRuleDefinition`
...
5. First see if you can alter all the echo statements. The `--dry-run` flag is your friend.
6. Now only update the echo statements that would print `I hate rector`
